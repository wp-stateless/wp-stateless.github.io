<!--
  Hi! Thanks for considering to file a bug with WP-Stateless. Please take the time to
  ...
  If you are unsure this is a bug in WP-Stateless, or this is a bug caused
...
- [ ] I believe this to be a bug, not a question about using WP-Stateless.
- [ ] I updated to the latest WP-Stateless
- [ ] I read the CONTRIBUTION file at https://-Stateless.github.com/Contributing
...
- [ ] I had an issue connecting to Google Cloud Storage.
- [ ] It was another bug.
...
<!--
  ...
  and look at them yourself, to determine if this is an actual WP-Stateless bug. In
...
/cc include any WP-Stateless affinity teams here (see https://teams.jekyllrb.com/ for more info)
